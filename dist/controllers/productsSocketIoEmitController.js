...
exports.initializeProducts = void 0;
    ...
    return __generator(this, function (_d) {
        switch (_d.label) {
            case 0:
                ...
                server_2.ioServer.sockets.emit('products-from-server', server_3.dao.getProductsSync());
                return [3 /*break*/, 5];
            case 1:
                _d.trys.push([1, 4, , 5]);
                _b = (_a = server_2.ioServer.sockets).emit;
                _c = ['products-from-server'];
                return [4 /*yield*/, server_3.dao.getProducts()];
            ...
            case 4:
                error_1 = _d.sent();
                console.error('initializeProducts()', error_1);
                return [3 /*break*/, 5];
...
exports.default = exports.initializeProducts;
